...
public class BookingControllerTest {
    ...
    void shouldCreateTest() throws Exception {
        ...
        when(bookingService.addBooking(eq(userId), any(BookingDtoIn.class))).thenReturn(responseDto);
        ...
        verify(bookingService, times(1))
                .addBooking(eq(userId), any(BookingDtoIn.class));
    ...
    void shouldUpdateBookingTest() throws Exception {
        ...
        when(bookingService.updateBooking(eq(userId), eq(responseDto.getId()), anyBoolean()))
        ...
        verify(bookingService, times(1))
                .updateBooking(eq(userId), eq(responseDto.getId()), anyBoolean());
        verifyNoMoreInteractions(bookingService);
    }
}