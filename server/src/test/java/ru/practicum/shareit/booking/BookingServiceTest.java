...
public class BookingServiceTest {
    ...
    void shouldCreateTest() {
        ...
        BookingDtoOut responseDto = bookingService.addBooking(booker.getId(), requestDto);
    ...
    void shouldNotBookOwnItemTest() {
        ...
        NotFoundException e = assertThrows(NotFoundException.class, () ->
                bookingService.addBooking(owner.getId(), requestDto));
    ...
    void shouldNotValidateTest() {
        ...
        BadRequestException e = assertThrows(BadRequestException.class, () ->
                bookingService.addBooking(owner.getId(), bookingDtoIn));
        BadRequestException e2 = assertThrows(BadRequestException.class, () ->
                bookingService.addBooking(owner.getId(), dtoIn));
    ...
    void shouldUpdateApprovedTest() {
        ...
        BookingDtoOut responseDto = bookingService.updateBooking(owner.getId(), booking.getId(), true);
    ...
    void shouldUpdateBookingRejectedTest() {
        ...
        BookingDtoOut responseDto = bookingService.updateBooking(owner.getId(), booking.getId(), false);
